...
<head>
	...
	<!-- =======================================DESCRIPCION======================================= -->
    <title>Politica de Cookies - Scarpetoss</title>
    ...
    <meta property="og:url" content="http://scarpetoss.infinityfreeapp.com/legalidad/politica-cookie.php">
    ...
    <meta property="twitter:url" content="http://scarpetoss.infinityfreeapp.com/legalidad/politica-cookie.php">
    <meta property="twitter:image" content="../image/logo.jpeg">
    <meta property="twitter:updated_time" content="2024-01-28T10:35:47+00:00">

	<!-- =======================================PRECONECCIONES	======================================= -->
    <meta rel="canonical" href="http://scarpetoss.infinityfreeapp.com/legalidad/politica-cookie.php">
    ...
    <main class="main-aviso-cookie">
        <div class="aviso-cookie">
            <div class="contenido-cookie">
                ...
                <p>Este sitio web utiliza cookies, tanto propias como de terceros. Más adelante el Usuario puede encontrar información concreta sobre las mismas.
                
                <h3><strong>¿Cómo se autoriza el uso de las cookies en nuestro sitio web?</strong></h3>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Proveedor</th>
                            <th>Politica de Privacidad y Opciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <span>Control de Sesion</span>
                            </td>
                            <td>
                                Se utilizara las cookies para proporcianar informacion sobre su inicio de sesion. Estos nos permite mantener el site en funcionamiento.
                            </td>
                            <td>
                                Scarpetoss
                            </td>
                            <td style="text-align: center;">
                                <a href="https://www.kaspersky.es/resource-center/definitions/cookies">Leer mas</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span>Control de Carrito</span>
                            </td>
                            <td>
                                Las cookies y el sessionstorage se usara para guardar de forma local todas las compras (falsas) que desee hacer. No se usara con otro fin.
                            </td>
                            <td>
                                Scarpetoss
                            </td>
                            <td style="text-align: center;">
                                <a href="https://developer.mozilla.org/es/docs/Web/API/Window/sessionStorage">Leer mas</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <p><strong>Firefox:</strong><a href="https://support.mozilla.org/es/kb/Deshabilitar%20cookies%20de%20terceros">  https://support.mozilla.org/es/kb/Deshabilitar%20c...</a></p>
                <p><strong>Chrome:</strong><a href="http://support.google.com/chrome/bin/answer.py?hl=es&answer=95647">  http://support.google.com/chrome/bin/answe...</a></p>
                <p><strong>Internet Explorer:</strong><a href="http://windows.microsoft.com/es-es/internet-explorer/delete-managecookies#ie=ie-11">  http://windows.microsoft.com/es-es...</a></p>
                <p><strong>Safari -> Seleccione safari -> Preferencias, haga click en Privacidad</strong></p>
                <p><strong>Opera:</strong><a href="http://help.opera.com/Windows/11.50/es-ES/cookies.html">  http://help.opera.com/...</a></p>
                <p><strong>Window Phone:</strong><a href="https://support.microsoft.com/es-es/help/10635/windows-phone-change-privacy-and-other-browser-settings">  https://support.microsoft.com/es-es/help/10635/window...</a></p>
                <p><strong>Android -> Ajuste del navegador utilizado -> Privacidad del navegador utilizado</strong></p>
