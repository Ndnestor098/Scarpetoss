...
<head>
	...
	<!-- =======================================DESCRIPCION======================================= -->
	<title>Registrar - Scarpetoss</title>
...
<body>
	<main class="registro">
		<div class="content-registro">
			...
			<form action="../php/register.php" method="post" enctype="application/x-www-form-urlencoded" class="FORMULARIOS">
				<div>
                ...
                <div style="flex-direction:row;justify-content: space-between;">
                    <div style="width: 100%;">
                        ...
                        <input type="text" id="clave-1" name="clave-1" placeholder="Clave*" required>
                    </div>
					<div style="width: 100%;">
                        <label for="clave-2">Confirmar Clave</label>
					    <input type="text" id="clave-2" name="clave-2" placeholder="Confirmar Clave*" required>
                    </div>
				</div>
                <div>
                    <p class="error"></p>
