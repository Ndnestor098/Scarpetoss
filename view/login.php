...
<head>
	...
	<!-- =======================================DESCRIPCION======================================= -->
	<title>Iniciar Sesion - Scarpetoss</title>
...
<body> 
	<main class="registro">
		<div class="content-registro">
			...
			<form action="../php/login.php" method="post" style="gap: 24px;" enctype="application/x-www-form-urlencoded" class="FORMULARIOS">
				<div>
				...
				<div style="flex-direction: row;">
					<input type="checkbox" name="recordarme-check" id="recordarme-check" style="padding: 0px 0px; box-shadow: none;">
					<label for="recordarme-check">Recordarme</label>
				</div>
