<?php
    ...
    $data = new Scarpetoss();
    $pro = $_GET['scarpe'];
    $data = $data->getProductSQL("SELECT * FROM productos WHERE producto_name = '$pro'");
...
<head>
	...
	<!-- =======================================DESCRIPCION======================================= -->
    <title>Producto - Scarpetoss</title>
...
<body>
    ...
    <main>
        ...
        <div class="url">
            <a href="/">Pagina de Inicio <span>></span></a>
            <a href="/shopping.php?prd=<?php echo $data['producto_genero'] ?>"><?php echo ucfirst($data['producto_genero']) ?></a>
        </div>
        ...
        <div class="Contenedor-Productos">
            ...
            <div class="part-img">
                <img src="<?php echo $data['producto_imageP'] ?>" alt="zapato - <?php echo $data['producto_name'] ?>">
            </div>
            <div class="info-producto">
                <div class="contenedor">
                    <div class="name-producto">
                        <h2><?php echo ucfirst($data['producto_proveedor']) ?></h2>
                        <p><?php echo $data['producto_name'] ?></p>
                    </div>
                    <div class="price">
                        <span>$<?php echo $data['producto_price'] ?>.00</span>
                        <p>El precio más bajo de los 30 días antes del descuento:<br> $<?php echo $data['producto_price'] ?>,00</p>
                    </div>
                    <div class="button-carrello">
                        <span onclick="contar(<?php echo $data['producto_ID'] ?>)">Agregar al Carrito</span>
                    </div>
