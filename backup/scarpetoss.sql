...
-- Tiempo de generación: 11-04-2024 a las 19:21:21
...
CREATE TABLE `productos` (
  ...
  `producto_genero` varchar(15) COLLATE utf8mb3_spanish2_ci NOT NULL,
...
INSERT INTO `productos` (`producto_ID`, `producto_name`, `producto_descripcion`, `producto_price`, `producto_genero`, `producto_imageP`, `producto_imageR`, `producto_stock`, `producto_proveedor`, `category_ID`, `size_ID`) VALUES
(2, 'Adidas Running Alphabounce Beyond', 'La última versión presenta una amortiguación suave y mullida que se siente instantáneamente cómoda. La marca alemana ha rediseñado la entresuela, eliminando la placa Speedboard e introduciendo el CloudTec Phase.', 19, 'unisex', '/image/imgProduct/adidas-running-alphabounce-beyond-P.webp', '/image/imgProduct/adidas-running-alphabounce-beyond-A.webp,', 98, 'Best Choice', 1, 1),
(3, 'Converse Chuck Taylor All Star Leather Hi', 'Las Converse Chuck Taylor son conocidas por su comodidad y versatilidad. Ofrecen una amortiguación equilibrada y una parte superior suave que se adapta bien al pie.', 22, 'mujer', '/image/imgProduct/converse_chuck_taylor_all_star_leather_hi-P.webp', '/image/imgProduct/champion_93_eighteen-A.webp,', 50, 'Converse', 1, 1),
(4, 'New Balance Fuelcore Nergize', 'Las Fuelcore Nergize de New Balance ofrecen una combinación de amortiguación y respuesta. Son ideales para corredores que buscan comodidad en sus entrenamientos diarios', 20, 'mujer', '/image/imgProduct/new_balance_fuelcore_nergize-P.webp', '/image/imgProduct/new_balance_fuelcore_nergize-A.webp,', 32, 'New Balance', 1, 1),
(5, 'Adidas Pharrell Williams Tenis Humano', 'Las Pharrell Williams brindan una amortiguación suave y una excelente absorción de impactos. Son ideales para corredores principiantes o intermedios que buscan una zapatilla cómoda para entrenamientos regulares.', 119, 'hombre', '/image/imgProduct/adidas_originals_pharrell_williams_tennis_human_race-P.webp', '/image/imgProduct/adidas_originals_pharrell_williams_tennis_human_race-A.webp,', 10, 'Adidas', 1, 1),
(6, 'Campeón 93 Dieciocho', 'Las Campeón 93 Dieciocho brindan una amortiguación suave y una excelente absorción de impactos. Son ideales para corredores principiantes o intermedios que buscan una zapatilla cómoda para entrenamientos regulares.', 18, 'hombre', '/image/imgProduct/champion_93_eighteen-P.webp', '/image/imgProduct/champion_93_eighteen-A.webp,', 80, 'Champion', 1, 1),
(7, 'Campeón Rally Pro', 'Las Campeón Rally Pro son conocidas por su durabilidad. La última versión presenta una amortiguación suave y mullida que se siente instantáneamente cómoda.', 25, 'hombre', '/image/imgProduct/champion_rally_pro-P.webp', '/image/imgProduct/champion_rally_pro-A.webp,', 80, 'Champion', 1, 1),
(8, 'Columbia Bahama Vent Relajado Pfg', ' Las cápsulas huecas se encuentran dentro de la espuma Helion, en diferentes ángulos diagonales y horizontales.', 37, 'hombre', '/image/imgProduct/columbia_bahama_vent_relaxed_pfg-P.webp', '/image/imgProduct/columbia_bahama_vent_relaxed_pfg-A.webp', 24, 'Columbia', 1, 1),
(9, 'Zapatos Agoura 52635/BBK Black', 'Son ideales para corredores que buscan comodidad en sus entrenamientos diarios.', 60, 'hombre', '/image/imgProduct/zapatos-skechers-agoura-P.webp', 'zapatos-skechers-agoura-A.webp,', 17, 'Skechers', 1, 1);
